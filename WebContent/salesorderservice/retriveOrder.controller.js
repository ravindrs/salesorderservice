...
//   }
	...
	searchAction : function() {
        ...
        var url = "proxy/https/sapes1.sapdevcenter.com/sap/opu/odata/sap/SALESORDERS/SOHeaders('"
                            + OrderId + "')";
        alert(url);
        oTitle.setText('Sales Order Details - ' + OrderId);
        salesResultPanel.setTitle(oTitle);
        rModel = new sap.ui.model.odata.ODataModel(url, false,
        		"P285136", "Initial123");
